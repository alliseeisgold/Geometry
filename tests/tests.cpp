...
TEST_F(SegmentTest, SegmentTest9) {
  ConstructTest(-1, -1, -9002, -2001, -19, -5, -1, -2001, 17, -1997, -8984,
                -3997);
  TestContainsPoint(false);
  TestCrossesSegment(false);
  TestMove();
...
TEST_F(SegmentTest, SegmentTest28) {
  ConstructTest(-9725, -8992, 9812, 9925, -9999, 7011, 8122, -9248, 8396,
                -25251, 27933, -6334);
  TestContainsPoint(false);
  TestCrossesSegment(true);
  TestMove();
...
TEST_F(SegmentTest, SegmentTest29) {
  ConstructTest(-10000, -10000, -9999, 10000, 10000, -10000, 9999, 10000,
                -10001, 10000, -10000, 30000);
  TestContainsPoint(false);
  TestCrossesSegment(false);
  TestMove();
}
...
TEST_F(LineTest, LineTest6) {
  ConstructTest(9999, 9999, 10000, 10000, -10000, -10000, 9999, 10000, 1, -1,
                1);
  TestContainsPoint(true);
  TestCrossesSegment(true);
  TestMove();
...
TEST_F(CircleTest, CircleTest10) {
  ConstructTest(10000, -10000, 10000, -10000, 0, -10000, -10000, 10000, -20000,
                10000);
  TestContainsPoint(false);
  TestCrossesSegment(false);
  TestMove();
